...
import { allProductFetherFromSanity, femaleProductsFromSanity, maleProductsFromSanity } from "@/components/utils/apicalling"
import { allProductFetherFromSanityType } from "@/components/utils/types";



const Male = async () => {
    let data = await femaleProductsFromSanity() as allProductFetherFromSanityType;
