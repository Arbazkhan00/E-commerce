...
import { allProductFetherFromSanity, maleProductsFromSanity } from "@/components/utils/apicalling"
import { allProductFetherFromSanityType } from "@/components/utils/types";



const Male = async () => {
    let data = await maleProductsFromSanity() as allProductFetherFromSanityType;
